  ...
  theme: {
    extend: {
      ...
      keyframes: {
        ...
        pulseGlow: {
          "0%, 100%": {
            boxShadow: "0 0 5px hsl(347 24% 59% / 0.5)",
          },
          "50%": {
            boxShadow: "0 0 20px hsl(347 24% 59% / 0.8), 0 0 30px hsl(347 24% 59% / 0.4)",
          },
        },
      },
      animation: {
        ...
        "fade-in-up-delay": "fadeInUp 1.2s ease-out 0.3s both",
        "fade-in-up-delay-long": "fadeInUp 1.2s ease-out 0.6s both",
